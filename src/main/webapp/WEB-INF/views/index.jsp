...
<body>
	<div class="g-body">
	    ...
	    <div class="col-xs-10 g-mainc">
	        <ul class="nav nav-tabs" id="navTabs">
	            <li class="active"><a href="#menuMark0" data-toggle="tab">功能管理</a></li>
	        </ul>
	        <div class="tab-content" id="tabContent">
	            <div id="menuMark0" class="tab-pane active"></div>
	        </div>
	    </div>
	</div>
	...
	<script type="text/javascript" src="${ctx}/styles/js/koala-ui.plugin.js"></script>	
	<script type="text/javascript" src="${ctx}/styles/js/index.js"></script>
