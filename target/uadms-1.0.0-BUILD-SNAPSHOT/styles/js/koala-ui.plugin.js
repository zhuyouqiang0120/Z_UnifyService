 ...
 */+ function() {"use strict";
	...
	Grid.prototype = {
		...
		_initLayout : function() {
			...
			this.gridTableBody.height(this.gridTableBody.height()*$(window).height()/700);
		...
		_loadData : function() {
			...
			if (self.sortName && self.sortOrder) {
				params.orderBy = self.sortName;
				params.order = self.sortOrder;
			}
			...
			$.ajax({
				...
				success : function(result){
					...
					self.totalRecordHtml.text(result.totalRecord);
